...
<html lang="en">
    ...
    <!-- Site Icons -->
    <link rel="shortcut icon" href="<%=request.getContextPath()%>/constructed/images/fevicon.ico.png" type="image/x-icon" />
    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="<%=request.getContextPath()%>/constructed/css/bootstrap.min.css">
    <!-- Site CSS -->
    <link rel="stylesheet" href="<%=request.getContextPath()%>/constructed/style.css">
    <!-- Colors CSS -->
    <link rel="stylesheet" href="<%=request.getContextPath()%>/constructed/css/colors.css">
    <!-- ALL VERSION CSS -->
    <link rel="stylesheet" href="<%=request.getContextPath()%>/constructed/css/versions.css">
    <!-- Responsive CSS -->
    <link rel="stylesheet" href="<%=request.getContextPath()%>/constructed/css/responsive.css">
    <!-- building CSS -->
    <link rel="stylesheet" href="<%=request.getContextPath()%>/constructed/css/building.css">
</head>
<body class="building_version" data-spy="scroll" data-target=".header">
    <!-- LOADER -->
    <div id="preloader">
        <img class="preloader" src="<%=request.getContextPath()%>/constructed/images/loaders/loader-building2.gif" alt="">
    </div>
    <!-- end loader -->
    <!-- END LOADER -->
        ...
        <nav class="megamenu navbar navbar-default" data-spy="affix">
            ...
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.html"><img src="<%=request.getContextPath()%>/constructed/images/logo-icon.png" alt="image"><span>Constructed</span></a>
                </div>
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav navbar-right">
                        <li class="active"><a data-scroll href="#home">Home</a></li>
                        <li><a data-scroll href="<%=request.getContextPath()%>/buku.htm">Buku</a></li>                        
    ...
    <div id="home" class="parallax first-section" data-stellar-background-ratio="0.4" style="background-image:url('<%=request.getContextPath()%>/constructed/uploads/building/slide-img1.png');">
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 col-md-offset-2 text-center">
                    <div class="big-tagline">
                        <img class="border-line-img" src="<%=request.getContextPath()%>/constructed/uploads/building/sep-line-white.png" alt="" />
                        <h2><span class="yellow">Construction</span></h2>
                        <img style="margin-bottom:40px;" class="border-line-img" src="<%=request.getContextPath()%>/constructed/uploads/building/sep-line-white.png" alt="" />
            ...
            <div class="row text-center about-row">
                    ...
                    <div class="row">
                        <div class="service-widget">
                            <div class="post-media wow fadeIn">
                                <a href="<%=request.getContextPath()%>/constructed/uploads/building_01.jpg" data-rel="prettyPhoto[gal]" class="hoverbutton global-radius"><i class="flaticon-unlink"></i></a>
                                <img src="<%=request.getContextPath()%>/constructed/uploads/building_01.jpg" alt="" class="img-responsive img-rounded">
                            </div>
                ...
                <div class="col-md-4 col-sm-12 col-xs-12">
                    <div class="row">
                        <div class="service-widget">
                            <div class="post-media wow fadeIn">
                                <a href="<%=request.getContextPath()%>/constructed/uploads/building_02.jpg" data-rel="prettyPhoto[gal]" class="hoverbutton global-radius"><i class="flaticon-unlink"></i></a>
                                <img src="<%=request.getContextPath()%>/constructed/uploads/building_02.jpg" alt="" class="img-responsive img-rounded">
                            </div>
                ...
                <div class="col-md-4 col-sm-12 col-xs-12">
                    <div class="row">
                        <div class="service-widget">
                            <div class="post-media wow fadeIn">
                                <a href="<%=request.getContextPath()%>/constructed/uploads/building_03.jpg" data-rel="prettyPhoto[gal]" class="hoverbutton global-radius"><i class="flaticon-unlink"></i></a>
                                <img src="<%=request.getContextPath()%>/constructed/uploads/building_03.jpg" alt="" class="img-responsive img-rounded">
                            </div>
                ...
                <div class="col-lg-7 col-md-6 col-sm-12 col-xs-12">
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <div class="service-inform">
                                <div class="icon-service">
                                    <img src="<%=request.getContextPath()%>/constructed/images/icon1.png" alt="#" />
                                </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <div class="service-inform">
                                <div class="icon-service">
                                    <img src="<%=request.getContextPath()%>/constructed/images/icon4.png" alt="#" />
                                </div>
                                <div class="service-inform-text">
                                    <h3>Service Two</h3>
                                    <p>Contrary to popular belief, Lorem Ipsum is not simply random text.</p>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 serv" style="background-color:#222;">
                    <div class="serv-blog">
                        <img src="<%=request.getContextPath()%>/constructed/images/sr1.png" alt="#" />
                    </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 serv" style="background:#181818;">
                    <div class="serv-blog">
                        <img src="<%=request.getContextPath()%>/constructed/images/sr2.png" alt="#" />
                    </div>
                    <div class="serv-blog-cont">
                        <h3>Fabrication</h3>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.</p>
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 serv" style="background:#222;">
                    <div class="serv-blog">
                        <img src="<%=request.getContextPath()%>/constructed/images/sr3.png" alt="#" />
                    </div>
                    <div class="serv-blog-cont">
                        <h3>Construction</h3>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.</p>
                            ...
                            <div class="col-md-8 col-sm-12 co-xs-12 gal-item">
                                <div class="box">
                                    <a href="#" data-toggle="modal" data-target="#1">
                                        <img src="<%=request.getContextPath()%>/constructed/images/pro1.png" alt="#" />
                                    </a>
                            ...
                            <div class="col-md-4 col-sm-6 co-xs-12 gal-item">
                                <div class="box">
                                    <a href="#" data-toggle="modal" data-target="#2">
                                        <img src="<%=request.getContextPath()%>/constructed/images/pro2.png" alt="#" />
                                    </a>
                            ...
                            <div class="col-md-4 col-sm-6 co-xs-12 gal-item">
                                <div class="box">
                                    <a href="#" data-toggle="modal" data-target="#3">
                                        <img src="<%=request.getContextPath()%>/constructed/images/pro3.png" alt="#" />
                                    </a>
                            ...
                            <div class="col-md-4 col-sm-6 co-xs-12 gal-item">
                                <div class="box">
                                    <a href="#" data-toggle="modal" data-target="#4">
                                        <img src="<%=request.getContextPath()%>/constructed/images/pro4.png" alt="#" />
                                    </a>
                    ...
                    <div class="testi-carousel owl-carousel owl-theme">
                        <div class="testimonial clearfix">
                            ...
                            <div class="testi-meta">
                                <img src="<%=request.getContextPath()%>/constructed/uploads/testi_01.png" alt="" class="img-responsive alignleft">
                        ...
                        <div class="testimonial clearfix">
                            ...
                            <div class="testi-meta">
                                <img src="<%=request.getContextPath()%>/constructed/uploads/testi_02.png" alt="" class="img-responsive alignleft">
                        ...
                        <div class="testimonial clearfix">
                            ...
                            <div class="testi-meta">
                                <img src="<%=request.getContextPath()%>/constructed/uploads/testi_03.png" alt="" class="img-responsive alignleft">
                ...
                <div class="col-md-4">
                    <div class="widget widget_text">
                        ...
                        <div class="textwidget">
                            <a class="navbar-brand" href="index-building.html"><img src="<%=request.getContextPath()%>/constructed/images/logo-icon.png" alt="image"><span>Constructed</span></a>
    ...
    <!-- ALL JS FILES -->
    <script src="<%=request.getContextPath()%>/constructed/js/all.js"></script>
    <!-- ALL PLUGINS -->
    <script src="<%=request.getContextPath()%>/constructed/js/custom.js"></script>
    <script src="<%=request.getContextPath()%>/constructed/js/portfolio.js"></script>
    <script src="<%=request.getContextPath()%>/constructed/js/hoverdir.js"></script>   
</body>
</html>
